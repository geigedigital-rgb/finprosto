...
export default function BundleSection({ onBuyBundle }) {
  ...
  return (
    <section className="py-10 sm:py-16 lg:py-24 bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 relative overflow-x-clip overflow-y-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-6 tracking-tight leading-tight">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">
                Фінансова система для контролю бізнесу
              </span>
            </h2>

            <p className="text-[15px] sm:text-xl text-emerald-100/80 mb-5 sm:mb-8 leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-0 sm:mb-8">
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 text-amber-400 fill-amber-400" />
                ))}
              </div>
              <span className="text-base text-white font-semibold">4.9/5</span>
              <span className="text-base text-emerald-200">Оцінили понад 800+ користувачів</span>
            </div>
          </motion.div>
          ...
          >
            <div className="relative">
              <div className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-3xl blur-2xl opacity-20 z-0" />

              <div className="relative bg-white rounded-3xl p-5 sm:p-8 lg:p-10 z-10">
                <div className="flex items-center justify-between mb-5 sm:mb-8">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center">
                ...
                <div className="relative h-44 sm:h-72 mb-6 sm:mb-12 flex items-center justify-center">
                  <motion.img
                    ...
                    className="w-full max-w-xs sm:max-w-md h-auto object-contain drop-shadow-lg"
                  />
                </div>
                ...
                <div className="flex items-center justify-between gap-3 mb-4 py-4 border-y border-slate-100">
                  <div>
